...
import SiteTitle from "../components/_core/SiteTitle.astro"
import SiteURL from "../components/_core/SiteURL.astro"

**Last Updated: August 25, 2024**

<b><SiteTitle /></b> ("we", "us", or "our") operates [
<b><SiteURL /></b>] (the "Site"). This page informs you of our policies regarding the collection,
