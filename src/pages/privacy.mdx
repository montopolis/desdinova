...
import desdinovaConfig from "../config/desdinova-config.ts"

**Last Updated: August 25, 2024**

<b>{desdinovaConfig.company}</b> ("we", "us", or "our") operates <b>{desdinovaConfig.name}</b> [{desdinovaConfig.url}] (the "Site").
